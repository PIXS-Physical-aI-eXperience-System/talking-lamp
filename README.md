...
| 역할 | 모델 | 실측 피크 메모리 |
| --- | --- | --- |
| 상황 인식 (VLM) | InternVL3.5-1B NF4, 1타일 | CUDA 피크 1.17 GB |
...
2026-09-12 실기 최적화에서는 STT→1B VLM→한국어 장면 렌더러→TTS를 순서대로
실행해 전체 시스템 피크 4.146GB, 최소 여유 RAM 3.703GB, swap 0을 기록했습니다.
같은 조건의 3회 반복과 네 장면 인식 검사, 생성 음성의 STT 왕복 검사를 통과했습니다.
자세한 결과는 `docs/benchmarks/jetson-ram-2026-09-12/README.md`에 있습니다.
